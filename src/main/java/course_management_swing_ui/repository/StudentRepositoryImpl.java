...
import course_management_swing_ui.repository.dao.StudentDAOImpl;
...
import static course_management_swing_ui.repository.dao.StudentDAOImpl.*;
...
public class StudentRepositoryImpl implements Repository<Student, Integer> {
    ...
    private synchronized void delete(Student obj, boolean value) {
        if (studentDAO.delete(obj.getNumericalId(), value)) {
